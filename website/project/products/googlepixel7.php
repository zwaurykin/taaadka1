            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                      ...
                      <div class="card">
                            <img src="/MOBITOS/images/images/6.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Google pixel 7 </h1>
                            ...
                            <p><button onclick="window.location.href='products/dogtoy.php';">Buy Now</button></p>
                          </div>
                    </div>
