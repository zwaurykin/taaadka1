            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                        ...
                        <div class="card">
                            <img src="/MobiloS/images/images/about.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Iphone X</h1>
                            <p class="price">$400</p>
                            <p> Iphone X available at 50% discount</p>
                            <p><button onclick="window.location.href='products/catnip.php';">Buy Now</button></p>
                          </div>
                    </div>
