            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                       ...
                       <div class="card">
                            <img src="/marketplace/Mobilos/images/images/2.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Samsung E1</h1>
                            <p class="price">$100.00</p>
                            <p>old model in very low price</p>
                            <p><button onclick="window.location.href='products/samsunge1.php';">Buy Now</button></p>
                          </div>
                    </div>
