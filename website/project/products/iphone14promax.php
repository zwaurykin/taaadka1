            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                        ...
                        <div class="card">
                            <img src="/MobiloS/images/images/4.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Iphone 14 pro max</h1>
                            ...
                            <p><button onclick="window.location.href='products/iphone14promax.php';">Buy Now</button></p>
                          </div>
                    </div>
