            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                         ...
                         <div class="card">
                            <img src="/MOBITOS/images/images/3.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>RedMi Note 4</h1>
                            <p class="price">$300.99</p>
                            <p>Best phone in your budget</p>
                            <p><button onclick="window.location.href='products/redminore4.php';">Buy Now</button></p>
                          </div>
                    </div>
