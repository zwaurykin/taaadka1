            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                        ...
                        <div class="card">
                            <img src="/images/images/5.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Moto G 5G</h1>
                            <p class="price">$400</p>
                            ...
                            <p><button onclick="window.location.href='products/moto5g.php';">Buy Now</button></p>
                          </div>
                    </div>
